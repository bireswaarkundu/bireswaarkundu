          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-xs font-mono-display">
              ...
              <div className="md:col-span-5 space-y-5 md:border-l md:border-[#1A1A1A]/10 md:pl-6">
                {/* Experience Section with Clean Minimal Timeline */}
                <div className="space-y-3">
                  ...
                  <div className="relative pl-6 space-y-4">
                    {/* 1. Precise Central Vertical Track Line */}
                    <div className="absolute left-[8px] top-1.5 bottom-1.5 w-[1.5px] bg-[#1A1A1A]/15 rounded-full overflow-hidden">
                      <div className="w-full bg-[#5D5CDE] h-full opacity-60"></div>
                    </div>
                    ...
                    <div className="group cursor-pointer transition-all duration-300 hover:translate-x-1.5 relative">
                      <span className="absolute left-[-15px] top-1 flex h-3 w-3 items-center justify-center -translate-x-1/2">
                        <span className="animate-ping absolute inline-flex h-3.5 w-3.5 rounded-full bg-[#5D5CDE] opacity-35"></span>
                        <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#5D5CDE] ring-2 ring-white shadow-xs"></span>
                      </span>
                    ...
                    <div className="group cursor-pointer transition-all duration-300 hover:translate-x-1.5 relative">
                      <span className="absolute left-[-15px] top-1 flex h-3 w-3 items-center justify-center -translate-x-1/2">
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-[#1A1A1A]/40 border border-white group-hover:bg-[#5D5CDE] group-hover:scale-125 transition-all duration-300"></span>
                      </span>
                      <div className="flex items-center justify-between">
